...
final.df <- rawdata.df %>%
  ...
  ## rename columns
  rename("clinvar_SNV" = SNV,
         "clinvar_Indels" = nIndels,
         "clinvar_total_variants" = total_variants,
         "clinvar_tstv_ratio" = tstv_ratio,
         "clinvar_missing" = nMissing,
         "clinvar_heterozygosity_ratio" = heterozygosity_ratio )
