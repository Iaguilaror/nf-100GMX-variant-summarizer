...
final.df <- rawdata.df %>%
  ...
  ## rename columns
  rename("nofilter_SNV" = SNV,
         "nofilter_Indels" = nIndels,
         "nofilter_total_variants" = total_variants,
         "nofilter_tstv_ratio" = tstv_ratio,
         "nofilter_missing" = nMissing,
         "nofilter_heterozygosity_ratio" = heterozygosity_ratio )
