...
final.df <- rawdata.df %>%
  ...
  ## rename columns
  rename("worldwide_singletons_SNV" = SNV,
         "worldwide_singletons_Indels" = nIndels,
         "worldwide_singletons_total_variants" = total_variants,
         "worldwide_singletons_tstv_ratio" = tstv_ratio,
         "worldwide_singletons_missing" = nMissing,
         "worldwide_singletons_heterozygosity_ratio" = heterozygosity_ratio )
