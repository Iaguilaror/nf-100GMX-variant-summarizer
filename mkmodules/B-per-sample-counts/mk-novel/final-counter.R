...
final.df <- rawdata.df %>%
  ...
  ## rename columns
  rename("novel_SNV" = SNV,
         "novel_Indels" = nIndels,
         "novel_total_variants" = total_variants,
         "novel_tstv_ratio" = tstv_ratio,
         "novel_missing" = nMissing,
         "novel_heterozygosity_ratio" = heterozygosity_ratio )
